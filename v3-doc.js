...
const apiConstructor = (path, method, data, url) => {
...
console.log( JSON.stringify(swaggerDocFormatter(data), null, 2) );
console.log( JSON.stringify(objectConstructor({
  "$ref": "#/components/schemas/MedicineDataDto"
}, data.components.schemas), null, 2) );